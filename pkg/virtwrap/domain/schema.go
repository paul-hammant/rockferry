...
// Schema represents the actual conversion to libvirt XML. The fields must be
...
type Disk struct {
	...
	FilesystemOverhead string        `xml:"filesystemOverhead,omitempty"`
